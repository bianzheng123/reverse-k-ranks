...
def run():
    ...
    for memory_capacity in [1, 2, 4, 8, 16]:
        ...
        os.system(
            ...
            f'--test_topk {"false"} --method_name {"Simpfer"} --simpfer_k_max {k_max} --stop_time {32000} --only_one_topk {"true"}')
    ...
    # n_sample = polyu.compute_n_sample_by_memory_index_sample_only(memory_capacity=memory_capacity,
