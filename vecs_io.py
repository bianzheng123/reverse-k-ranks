...
if __name__ == '__main__':
    item_l, d = dvecs_read(
        '/run/media/hdd/ReverseMIPS/amazon/amazon_data_item.dvecs')
    user_l, d = dvecs_read(
        '/run/media/hdd/ReverseMIPS/amazon/amazon_user.dvecs')
    query_l, d = dvecs_read(
        '/run/media/hdd/ReverseMIPS/amazon/amazon_query_item.dvecs')
    print(item_l)
    print(user_l)
    print(query_l)
