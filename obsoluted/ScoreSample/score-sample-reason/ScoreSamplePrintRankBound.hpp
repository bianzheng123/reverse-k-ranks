...
namespace ReverseMIPS::ScoreSamplePrintRankBound {
    ...
    void MeasurePruneRatio(const char *dataset_name, const char *basic_dir, const char *memory_index_path,
        ...
        std::unique_ptr<ScoreSamplePrintRankBound::Index> index =
                ScoreSamplePrintRankBound::BuildIndex(data_item, user, memory_index_path);

        std::string method_name = "ScoreSamplePrintRankBound";
