...
namespace ReverseMIPS {
    ...
    public:
        ...
        double
        IPUpperBound(const double *user_vecs, const int &userID, const double *item_vecs, const int &itemID) {
        ...
        double
        IPLowerBound(const double *user_vecs, const int &userID, const double *item_vecs, const int &itemID) {
            const unsigned char *user_code_ptr = user_codeword_.get() + userID * vec_dim_;
            const unsigned char *item_code_ptr = item_codeword_.get() + itemID * vec_dim_;
            double IP_lb = 0;
            for (int dim = 0; dim < vec_dim_; dim++) {
        ...
        IPBound(const double *user_vecs, const int &userID, const double *item_vecs, const int &itemID) {
            const unsigned char *user_code_ptr = user_codeword_.get() + userID * vec_dim_;
            const unsigned char *item_code_ptr = item_codeword_.get() + itemID * vec_dim_;
            double IP_ub = 0;
            double IP_lb = 0;
        ...
        IPBound(const double *user_vecs, const int &userID,
                ...
                std::pair<double, double> *IPbound_l) {
