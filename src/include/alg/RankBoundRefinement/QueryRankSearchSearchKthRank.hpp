...
#ifndef REVERSE_KRANKS_QUERYRANKSEARCHSEARCHKTHRANK_HPP
#define REVERSE_KRANKS_QUERYRANKSEARCHSEARCHKTHRANK_HPP
...
namespace ReverseMIPS {
    ...
    public:
        ...
        inline SearchKthRank() = default;

        inline SearchKthRank(const uint64_t &n_user, const uint64_t &n_data_item,
...
//            }
    ...
    class QueryRankSearchSearchKthRank {
    ...
    public:
        ...
        inline QueryRankSearchSearchKthRank(const int &n_sample, const int &n_data_item,
        ...
        inline QueryRankSearchSearchKthRank(const char *index_basic_dir, const char *dataset_name,
        ...
        void Preprocess(const char *dataset_name, const int &n_sample_query, const int &sample_topk,
            ...
            SearchKthRank query_distribution_ins((int) n_user_, (int) n_data_item_, dataset_name,
...
//                        }
        ...
        void SaveIndex(const char *index_basic_dir, const char *dataset_name, const char *method_name,
                       const bool &save_sample_score) {
            char index_path[256];
            if (save_sample_score) {
                sprintf(index_path,
                        "%s/memory_index/%s-%s-n_sample_%ld-n_sample_query_%ld-sample_topk_%ld.index",
                        index_basic_dir, method_name, dataset_name, n_sample_, n_sample_query_, sample_topk_);
            } else {
                sprintf(index_path,
                        "%s/qrs_to_sample_index/%s-%s-n_sample_%ld-n_sample_query_%ld-sample_topk_%ld.index",
                        index_basic_dir, method_name, dataset_name, n_sample_, n_sample_query_, sample_topk_);
            }
        ...
        void SaveNewIndex(const char *index_basic_dir, const char *dataset_name, const char *method_name,
                          const bool &save_sample_score) {
            char index_path[256];
            if (save_sample_score) {
                sprintf(index_path,
                        "%s/new_memory_index/%s-%s-n_sample_%ld-n_sample_query_%ld-sample_topk_%ld.index",
                        index_basic_dir, method_name, dataset_name, n_sample_, n_sample_query_, sample_topk_);
            } else {
                sprintf(index_path,
                        "%s/new_qrs_to_sample_index/%s-%s-n_sample_%ld-n_sample_query_%ld-sample_topk_%ld.index",
                        index_basic_dir, method_name, dataset_name, n_sample_, n_sample_query_, sample_topk_);
            }
        ...
        void LoadIndex(const char *index_basic_dir, const char *dataset_name, const char *method_name,
            ...
            if (load_sample_score) {
                sprintf(index_path,
                        "%s/memory_index/%s-%s-n_sample_%ld-n_sample_query_%ld-sample_topk_%ld.index",
                        index_basic_dir, method_name, dataset_name, n_sample, n_sample_query, sample_topk);
            } else {
                sprintf(index_path,
                        "%s/qrs_to_sample_index/%s-%s-n_sample_%ld-n_sample_query_%ld-sample_topk_%ld.index",
                        index_basic_dir, method_name, dataset_name, n_sample, n_sample_query, sample_topk);
...
#endif //REVERSE_KRANKS_QUERYRANKSEARCHSEARCHKTHRANK_HPP
