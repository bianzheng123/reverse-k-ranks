...
#ifndef REVERSE_KRANKS_IRBPARTDIMPARTINT_HPP
#define REVERSE_KRANKS_IRBPARTDIMPARTINT_HPP
...
namespace ReverseMIPS::IntervalRankBound {
    ...
    public:
        ...
        SVD svd_ins_;
        PartDimPartIntPrune itv_search_prune_;
        ...
        Index(
                ...
                //interval search bound
                SVD &svd_ins, PartDimPartIntPrune &itv_search_prune,
                // rank search
    ...
    Index &BuildIndex(VectorMatrix &user, VectorMatrix &data_item, const char *index_path) {
        ...
        PartDimPartIntPrune itv_search_prune;
...
#endif //REVERSE_KRANKS_IRBPARTDIMPARTINT_HPP
