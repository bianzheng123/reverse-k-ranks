...
namespace ReverseMIPS::IntervalRankBound {
    ...
    public:
        ...
        SVD svd_ins_;
        PartDimPartNormPrune itv_search_prune_;
        ...
        Index(
                ...
                //interval search bound
                SVD &svd_ins, PartDimPartNormPrune &itv_search_prune,
                // rank search
    ...
    Index &BuildIndex(VectorMatrix &user, VectorMatrix &data_item, const char *index_path) {
        ...
        PartDimPartNormPrune itv_search_prune;
        itv_search_prune.Preprocess(user, check_dim);
