...
#ifndef REVERSE_KRANKS_IRBFULLINT_HPP
...
namespace ReverseMIPS::IntervalRankBound {
    ...
    public:
        ...
        SVD svd_ins_;
        FullIntPrune itv_search_prune_;
        ...
        Index(
                ...
                //interval search bound
                SVD &svd_ins, FullIntPrune &itv_search_prune,
                // rank search
...
#endif //REVERSE_KRANKS_IRBFULLINT_HPP
