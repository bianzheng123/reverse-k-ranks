...
#define cublasCheckErrors(fn) \
    ...
    class GPUSort {
        ...
        thrust::host_vector<double> ip_host_vecs_;
        thrust::device_vector<double> ip_device_vecs_;
    public:
        GPUSort() = default;
        ...
        void SortList(const double *distance_l, DistancePair *distance_pair_l) {
        ...
        void SortList(double *distance_l) {
            thrust::copy(distance_l, distance_l + n_data_item_, ip_device_vecs_.begin());
