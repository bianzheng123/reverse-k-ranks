...
namespace ReverseMIPS {
    ...
    public:
        ...
        std::map<double, unsigned int, std::greater<>> topk_;
        double threshold_ = -DBL_MAX;
        std::vector<double> lowerbound_array_;
        ...
        // k-MIPS update
        void UpdateTopk(const double ip, const unsigned int id, const unsigned int k_) {
    ...
    public:
        ...
        std::vector<double> lowerbound_array;
