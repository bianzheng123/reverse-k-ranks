...
#ifndef REVERSE_KRANKS_INTERVALSEARCHCACHEBOUND_HPP
#define REVERSE_KRANKS_INTERVALSEARCHCACHEBOUND_HPP
...
namespace ReverseMIPS::IntervalSearchCacheBound {
...
#endif //REVERSE_KRANKS_INTERVALSEARCHCACHEBOUND_HPP
