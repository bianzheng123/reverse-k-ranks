...
#ifndef REVERSE_KRANKS_IRBFULLDIMPRUNE_HPP
#define REVERSE_KRANKS_IRBFULLDIMPRUNE_HPP

#include "alg/DiskIndex/ReadAll.hpp"
#include "alg/Prune/IPbound/FullDimPrune.hpp"
...
namespace ReverseMIPS::IRBFullDimPrune {
...
#endif //REVERSE_KRANKS_IRBFULLDIMPRUNE_HPP
