//
// Created by BianZheng on 2022/12/6.
//

#ifndef REVERSE_K_RANKS_QUERYRANKSAMPLESEARCHUNIFORMRANKMINMAXINTLR_HPP
#define REVERSE_K_RANKS_QUERYRANKSAMPLESEARCHUNIFORMRANKMINMAXINTLR_HPP
...
namespace ReverseMIPS::QueryRankSampleSearchUniformRankMinMaxIntLR {
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *disk_index_path, const char *dataset_name,
        ...
        MinMaxLinearRegression rank_bound_ins(index_basic_dir, dataset_name, n_sample, n_sample_query, sample_topk, true);
...
#endif //REVERSE_K_RANKS_QUERYRANKSAMPLESEARCHUNIFORMRANKMINMAXINTLR_HPP
