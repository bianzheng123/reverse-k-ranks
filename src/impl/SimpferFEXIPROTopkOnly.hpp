...
#ifndef REVERSE_KRANKS_SIMPFERFEXIPROTOPKONLY_HPP
#define REVERSE_KRANKS_SIMPFERFEXIPROTOPKONLY_HPP
...
namespace ReverseMIPS::SimpferFEXIPROTopkOnly {
    ...
    public:
        SimpferFEXIPROOnlyIndex simpfer_index_;
        Matrix user_matrix_;

        VectorMatrix user_, data_item_;
        int vec_dim_, n_data_item_, n_user_;
        size_t stop_time_;
        int test_reverse_topk_;
        double total_retrieval_time_;
        TimeRecord total_retrieval_record_;
        size_t total_ip_cost_;

        Index(
                SimpferFEXIPROOnlyIndex &&simpfer_index, Matrix &&user_matrix,
                //general retrieval
                VectorMatrix &user, VectorMatrix &data_item, const size_t &stop_time, const int &test_reverse_topk)
            ...
            this->test_reverse_topk_ = test_reverse_topk;
        ...
        Retrieval(const VectorMatrix &query_item, const int &topk, const int &n_execute_query,
            ...
            for (int queryID = 0; queryID < n_query_item; queryID++) {
                ...
                int rtk_topk = test_reverse_topk_;
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const int &simpfer_k_max, const size_t &stop_time,
        ...
        SimpferFEXIPROOnlyIndex simpfer_index(user_sd_l, data_item_sd_l, block_l,
                                              std::move(sirPrune),
                                              simpfer_k_max,
        ...
        std::unique_ptr<Index> index_ptr = std::make_unique<Index>(
                ...
                //general retrieval
                user, data_item,
                stop_time, test_reverse_topk);
        return index_ptr;
    }

}
#endif //REVERSE_KRANKS_SIMPFERFEXIPROTOPKONLY_HPP
