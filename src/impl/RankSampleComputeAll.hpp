//
// Created by bianzheng on 2023/3/8.
//

#ifndef REVERSE_KRANKS_RANKSAMPLECOMPUTEALL_HPP
#define REVERSE_KRANKS_RANKSAMPLECOMPUTEALL_HPP
...
namespace ReverseMIPS::RankSampleComputeAll {
    ...
    public:
        ...
        Index(//rank search
            ...
            this->n_data_item_ = data_item_.n_vector_;
...
//                spdlog::info(
//                        "queryID {}, query_time {:.2f}s, total_refine_ip_cost {}, total_retrieval_time {:.2f}s",
//                        queryID, total_time, total_refine_ip_cost_, total_retrieval_time_);
            }
...
#endif //REVERSE_KRANKS_RANKSAMPLECOMPUTEALL_HPP
