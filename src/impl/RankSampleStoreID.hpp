...
#ifndef REVERSE_KRANKS_RANKSAMPLESTOREID_HPP
#define REVERSE_KRANKS_RANKSAMPLESTOREID_HPP

#include "alg/SpaceInnerProduct.hpp"
#include "alg/TopkLBHeap.hpp"
#include "alg/DiskIndex/ReadAllID.hpp"
...
namespace ReverseMIPS::RankSampleStoreID {
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *index_path, const int &n_sample) {
        ...
        //disk index
        ReadAllID disk_ins(n_user, n_data_item, vec_dim, index_path);
...
#endif //REVERSE_KRANKS_RANKSAMPLESTOREID_HPP
