//
// Created by BianZheng on 2022/10/13.
//

#ifndef REVERSE_K_RANKS_LINEARMODEL_HPP
#define REVERSE_K_RANKS_LINEARMODEL_HPP
...
namespace ReverseMIPS::LinearModel {
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *index_path) {
        ...
        //rank search
        PGMSearch rank_ins(n_data_item, n_user);
        rank_ins.StartPreprocess();
...
#endif //REVERSE_K_RANKS_LINEARMODEL_HPP
