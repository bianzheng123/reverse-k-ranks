...
#ifndef REVERSE_K_RANKS_QUERYRANKSAMPLEUNIFORMINTLR_HPP
#define REVERSE_K_RANKS_QUERYRANKSAMPLEUNIFORMINTLR_HPP
...
namespace ReverseMIPS::QueryRankSampleUniformIntLR {
...
#endif //REVERSE_K_RANKS_QUERYRANKSAMPLEUNIFORMINTLR_HPP
