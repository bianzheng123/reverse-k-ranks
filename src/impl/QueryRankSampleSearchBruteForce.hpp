...
#ifndef REVERSE_K_RANKS_QUERYRANKSAMPLESEARCHBRUTEFORCE_HPP
#define REVERSE_K_RANKS_QUERYRANKSAMPLESEARCHBRUTEFORCE_HPP
...
namespace ReverseMIPS::QueryRankSampleSearchBruteForce {
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *index_path, const char *dataset_name,
        ...
        //rank search
        SampleSearch rank_ins(index_basic_dir, dataset_name, "QueryRankSampleSearchBruteForce",
                              n_sample, true, true,
...
#endif //REVERSE_K_RANKS_QUERYRANKSAMPLESEARCHBRUTEFORCE_HPP
