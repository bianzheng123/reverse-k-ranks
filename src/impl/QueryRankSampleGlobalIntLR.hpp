...
#ifndef REVERSE_K_RANKS_QUERYRANKSAMPLEGLOBALINTLR_HPP
#define REVERSE_K_RANKS_QUERYRANKSAMPLEGLOBALINTLR_HPP
...
namespace ReverseMIPS::QueryRankSampleGlobalIntLR {
    ...
    class Index : public BaseIndex {
        ...
        //rank bound search
        GlobalLinearRegression rank_bound_ins_;
        //rank search
    ...
    public:
        ...
        Index(
                ...
                GlobalLinearRegression &rank_bound_ins,
                //rank search
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *disk_index_path, const char *dataset_name,
        ...
        GlobalLinearRegression rank_bound_ins(index_basic_dir, dataset_name, n_data_item);
...
#endif //REVERSE_K_RANKS_QUERYRANKSAMPLEGLOBALINTLR_HPP
