//
// Created by BianZheng on 2022/11/10.
//

#ifndef REVERSE_KRANKS_QUERYRANKSAMPLEDIRECTINTLR_HPP
#define REVERSE_KRANKS_QUERYRANKSAMPLEDIRECTINTLR_HPP
...
namespace ReverseMIPS::QueryRankSampleDirectIntLR {
    ...
    class Index : public BaseIndex {
        ...
        //rank bound search
        DirectLinearRegression rank_bound_ins_;
        //rank search
    ...
    public:
        ...
        Index(
                ...
                DirectLinearRegression &rank_bound_ins,
                //rank search
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *disk_index_path, const char *dataset_name,
        ...
        DirectLinearRegression rank_bound_ins(index_basic_dir, dataset_name, n_sample, n_sample_query, sample_topk);
...
#endif //REVERSE_KRANKS_QUERYRANKSAMPLEDIRECTINTLR_HPP
