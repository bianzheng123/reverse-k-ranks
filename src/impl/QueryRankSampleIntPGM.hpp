...
#ifndef REVERSE_K_RANKS_QUERYRANKSAMPLEINTPGM_HPP
#define REVERSE_K_RANKS_QUERYRANKSAMPLEINTPGM_HPP
...
namespace ReverseMIPS::QueryRankSampleIntPGM {
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *index_path, const char *dataset_name,
        ...
        ///TODO modify to the rank bound instance
...
#endif //REVERSE_K_RANKS_QUERYRANKSAMPLEINTPGM_HPP
