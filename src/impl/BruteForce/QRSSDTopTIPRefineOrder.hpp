...
#ifndef REVERSE_K_RANKS_QRSSDTOPTIP_HPP
#define REVERSE_K_RANKS_QRSSDTOPTIP_HPP
...
namespace ReverseMIPS::QRSSDTopTIPRefineOrder {
    ...
    public:
        ...
        QRSScoreDistribution rank_bound_ins_;
        //read all instance
        TopTIP disk_ins_;
        ...
        Index(
                // hash search
                QRSScoreDistribution &rank_bound_ins,
                //disk index
                TopTIP &disk_ins,
                //general retrieval
    ...
    std::unique_ptr<Index> BuildIndex(VectorMatrix &data_item, VectorMatrix &user,
                                      const char *index_path, const char *dataset_name,
                                      const int &n_sample, const int &n_sample_score_distribution,
...
//            topt = n_data_item / 2;
        ...
        //hash search
        QRSScoreDistribution rank_bound_ins(n_sample, n_sample_score_distribution,
                                            n_data_item, n_user,
...
#endif //REVERSE_K_RANKS_QRSSDTOPTIP_HPP
