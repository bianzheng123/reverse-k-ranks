...
#ifndef REVERSE_K_RANKS_QRSTOPTIPREFINEORDER_HPP
#define REVERSE_K_RANKS_QRSTOPTIPREFINEORDER_HPP
...
namespace ReverseMIPS::QRSTopTIPRefineOrder {
...
#endif //REVERSE_K_RANKS_QRSTOPTIPREFINEORDER_HPP
