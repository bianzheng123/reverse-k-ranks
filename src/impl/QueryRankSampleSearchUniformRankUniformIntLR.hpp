...
#ifndef REVERSE_K_RANKS_QUERYRANKSAMPLESEARCHUNIFORMRANKUNIFORMINTLR_HPP
#define REVERSE_K_RANKS_QUERYRANKSAMPLESEARCHUNIFORMRANKUNIFORMINTLR_HPP
...
namespace ReverseMIPS::QueryRankSampleSearchUniformRankUniformIntLR {
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *disk_index_path, const char *dataset_name,
        ...
        UniformLinearRegression rank_bound_ins(index_basic_dir, dataset_name, n_sample, true);
...
#endif //REVERSE_K_RANKS_QUERYRANKSAMPLESEARCHUNIFORMRANKUNIFORMINTLR_HPP
