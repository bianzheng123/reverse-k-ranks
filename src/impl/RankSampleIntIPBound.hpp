...
#ifndef REVERSE_KRANKS_RANKSAMPLEINTIPBOUND_HPP
#define REVERSE_KRANKS_RANKSAMPLEINTIPBOUND_HPP
...
namespace ReverseMIPS::RankSampleIntIPBound {
...
#endif //REVERSE_KRANKS_RANKSAMPLEINTIPBOUND_HPP
