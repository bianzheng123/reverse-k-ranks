...
#ifndef REVERSE_K_RANKS_RANKSAMPLEAPPRBYUSERIPBOUND_HPP
#define REVERSE_K_RANKS_RANKSAMPLEAPPRBYUSERIPBOUND_HPP

#include "alg/SpaceInnerProduct.hpp"
#include "alg/TopkMaxHeap.hpp"
#include "alg/DiskIndex/ReadAll.hpp"
#include "alg/DiskIndex/ReadAllDirectIO.hpp"
#include "alg/QueryIPBound/ApproximateByUser.hpp"
...
namespace ReverseMIPS::RankSampleApprByUserIPBound {
    ...
    class Index : public BaseIndex {
        ...
        // IP Bound
        ApproximateByUser ip_bound_ins_;
        //rank search
    ...
    public:
        ...
        Index(
                //ip bound ins
                ApproximateByUser &ip_bound_ins,
                //rank search
                RankSearch &rank_ins,
                //disk index
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *index_path, const int &n_sample) {
        ...
        ApproximateByUser ip_bound_ins(n_user, n_data_item, vec_dim, 128);
...
#endif //REVERSE_K_RANKS_RANKSAMPLEAPPRBYUSERIPBOUND_HPP
