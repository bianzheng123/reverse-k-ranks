...
#ifndef REVERSE_K_RANKS_MEASURETOPTID_HPP
#define REVERSE_K_RANKS_MEASURETOPTID_HPP
...
namespace ReverseMIPS::MeasureTopTID {
    class MeasureTopTID {
    ...
    public:
        ...
        inline MeasureTopTID() = default;

        inline MeasureTopTID(const int &n_user, const int &n_data_item, const int &vec_dim,
...
#endif //REVERSE_K_RANKS_MEASURETOPTID_HPP
