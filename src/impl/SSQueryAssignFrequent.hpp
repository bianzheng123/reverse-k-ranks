...
#ifndef REVERSE_KRANKS_SSQUERYASSIGNFREQUENT_HPP
...
namespace ReverseMIPS::SSQueryAssignFrequent {
    ...
    std::unique_ptr<Index> BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *index_path,
                                      const int &n_sample, const size_t &index_size_gb,
        ...
        //disk index
        QueryAssignFrequent disk_ins(n_user, n_data_item, vec_dim, index_path,
                                     index_size_gb,
        ...
        //interval search
        ScoreSearch interval_ins(n_sample, n_user, n_data_item);
        ...
        for (int userID = 0; userID < n_user; userID++) {
            ...
            disk_ins.BuildIndexLoop(distance_l.data(), userID);
...
#endif //REVERSE_KRANKS_SSQUERYASSIGNFREQUENT_HPP
