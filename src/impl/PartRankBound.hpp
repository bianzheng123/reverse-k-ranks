...
#ifndef REVERSE_K_RANKS_PARTRANKBOUND_HPP
#define REVERSE_K_RANKS_PARTRANKBOUND_HPP
...
#include "alg/Prune/PartRankSearch.hpp"
#include <string>
#include <fstream>
#include <vector>
#include <algorithm>
...
namespace ReverseMIPS::PartRankBound {
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *index_path,
               const int &cache_bound_every, const int &n_sample) {
        ...
        //rank search
        PartRankSearch rank_ins(cache_bound_every, n_sample, n_data_item, n_user);
        //disk index
...
#endif //REVERSE_K_RANKS_PARTRANKBOUND_HPP
