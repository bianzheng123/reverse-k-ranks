...
#ifndef REVERSE_K_RANKS_SIMPFERFEXIPROONLY_HPP
#define REVERSE_K_RANKS_SIMPFERFEXIPROONLY_HPP
...
namespace ReverseMIPS::SimpferFEXIPROOnly {
...
#endif //REVERSE_K_RANKS_SIMPFERFEXIPROONLY_HPP
