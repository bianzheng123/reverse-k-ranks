...
if __name__ == '__main__':
    item_l, d = fvecs_read('/home/bianzheng/Dataset/Reverse-MIPS/netflix/netflix_item.fvecs')
    user_l, d = fvecs_read('/home/bianzheng/Dataset/Reverse-MIPS/netflix/netflix_user.fvecs')
    item_l = item_l[:1000, :]
    user_l = user_l[:1000, :]
