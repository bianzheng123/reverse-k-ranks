...
if __name__ == '__main__':
    ...
    os.system('python3 create_test_dataset.py')
    ...
    for ds in dataset_l:
        os.system(
            'cd ../../build && ./rri --dataset_name {} --method_name {} --n_sample {}'.format(ds, 'RankSample', 5))
        os.system(
            'cd ../../build && ./progress --method_name {} --dataset_name {} --n_sample {}'.format('QueryRankSample',
                                                                                                   ds, 5))
