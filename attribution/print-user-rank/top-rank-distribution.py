...
rank_l = np.loadtxt('../../result/attribution/print-user-rank-top-70-netflix.csv', delimiter=',')
scatter_x = rank_l[:, 0]
...
# ax.set(xlim=(0, n_data_item), xticks=np.arange(1, n_data_item),
#        ylim=(0, n_data_item), yticks=np.arange(1, n_data_item))
ax.set(xlim=(0, 2000),
       ylim=(0, 2000))
