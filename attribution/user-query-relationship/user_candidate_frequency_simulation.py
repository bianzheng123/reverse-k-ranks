...
def show_bin_hist(hist):
    ...
    plt.savefig('{}-top{}-reverse-k-rank-sorted-frequency-simulation.jpg'.format(dataset_name, topk),
...
if __name__ == '__main__':
    for dataset_name in ['fake-normal', 'netflix-small']:
        for topk in [10, 50, 1000]:
            ...
            print("after sort")
            np.savetxt('{}-top{}-reverse-k-rank-sorted-frequency-simulation.txt'.format(dataset_name, topk),
