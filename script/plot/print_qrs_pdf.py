...
def get_sample_ip_l():
    ...
    f = open(
        '/home/bianzheng/reverse-k-ranks/index/memory_index_important/QueryRankSearchKthRank-movielens-27m-n_sample_947-n_sample_query_5000-sample_topk_600.index',
        'rb')
...
# print(sample_rank_l)
show_hist(sample_rank_l, 'Movielens', 'pdf_query_rank_sample_user_{}.jpg'.format(0))
