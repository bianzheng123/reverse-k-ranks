...
# plot NaN title 'WORKER\_1' with linespoints linetype 1 pointtype 11, \
# NaN title 'WORKER\_2' with linespoints linetype 1 pointtype 12,\
#  NaN title 'WORKER\_4' with linespoints linetype 1 pointtype 13, \
# NaN title 'WORKER\_8' with linespoints linetype 1 pointtype 14
...
#=========================================
set size 1.25000,0.7200000;  
set origin 0.0,0.0;

set xlabel  "Worker number"
...
plot "parallelism-range.txt" using 1:2  title "SMALL" with linespoints linetype 1 pointtype 10, \
"parallelism-range.txt" using 1:3  title "MEDIAN" with linespoints linetype 1 pointtype 12, \
"parallelism-range.txt" using 1:5  title "LARGE" with linespoints linetype 1 pointtype 16

set output "parallelism-2.eps"
...
# plot "indexTime.res" using 1:5  notitle with linespoints linetype 1 pointtype 10, \
# "indexTime.res" using 1:6 notitle with linespoints linetype 1 pointtype 6
plot "parallelism-knn.txt" using 1:2  title "k=2" with linespoints linetype 1 pointtype 10, \
"parallelism-knn.txt" using 1:3  title "k=8" with linespoints linetype 1 pointtype 12, \
"parallelism-knn.txt" using 1:5  title "k=64" with linespoints linetype 1 pointtype 16


# "parallelism-knn.txt" using 1:4  title "32" with linespoints linetype 1 pointtype 14, \
